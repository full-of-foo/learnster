Learnster::Application.routes.draw do
  ...
  scope "api" do
    ...
    resources :org_admin, :controller => "org_admin", :type => "OrgAdmin"
    resources :app_admin, :controller => "app_admin", :type => "AppAdmin"
    resources :student, :controller => "student", :type => "Student"
