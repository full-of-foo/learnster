...
Student.first.update(email: "student@foo.com", password: "foobar", password_confirmation: "foobar")
OrgAdmin.first.update(email: "admin@foo.com", password: "foobar", password_confirmation: "foobar")
